...
#            window = rg.RoseWindow(width,height,label)
#
...
#             objects have:
#                F_STRING, CENTER, RADIUS
#
#     f. What does a RoseWindow RENDER method do?
#            UPDATES AND DRAWS THE SHAPE
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            WHEN THE PROGRAM ENDS, THE ROSEWINDOW CLOSES AUTOMATICALLY, SO A LINE TO KEEP IT OPEN UNTIL IT NEEDS TO BE CLOSED IS NECESSARY
#
