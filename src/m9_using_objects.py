...
def two_circles():
    ...
    circle1 = rg.Circle(rg.Point(200,50),30)
    circle1.fill_color = 'blue'
    circle1.attach_to(window)

    circle2 = rg.Circle(rg.Point(100,200),40)
...
def circle_and_rectangle():
    ...
    rect = rg.Rectangle(rg.Point(150,100),rg.Point(300,200))
...
def lines():
    ...
    line1 = rg.Line(rg.Point(20,20),rg.Point(150,20))
    line1.attach_to(window)
    line2 = rg.Line(rg.Point(100,100),rg.Point(300,200))
